...
class ExpenseService:
    def __init__(self, expense_repo: ExpensesRepository,
    ...
    def get_expenses(self, skip: int, limit: int) -> list[ExpenseRead]:
        return [ExpenseRead.model_validate(expense) for expense in
                self.expense_repo.get_all_expenses(skip, limit)]
